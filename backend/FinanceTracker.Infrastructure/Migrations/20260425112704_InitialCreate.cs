    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OneOffTransaction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OneOffTransaction_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledDayOfMonth = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OneOffTransaction_UserId",
                table: "OneOffTransaction",
                column: "UserId");
